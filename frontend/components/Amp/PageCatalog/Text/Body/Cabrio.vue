    ...
    <div class="text-information__content">
      <UiContentOverflow heightDefault="184">
        <div class="text-information__description">
          ...
          <h4>&ensp;&ensp;Perfect Climate</h4>
          <p>
            Cruising along iconic places like Sheikh Zayed Road or the Palm
            Jumeirah with the top-down makes sightseeing even more enjoyable.
          ...
          <ul class="text-information__ul">
            <li class="text-information__li">
              <strong>Prestige</strong>: Cabriolets represent sophistication and
              high status. Driving a high-end cabriolet is a way to make a
          ...
          <p>
            To rent a cabriolet in Dubai, you will need a passport, a valid
            driving license, and an identification code. Drivers must be at
            least 21 years old, and previous driving experience is highly
            recommended.
          </p>
          <br />
          <h3  >
          ...
          <br />
          <h4>&ensp;&ensp;Safety</h4>
          <p>
            Drive with peace of mind knowing that all our vehicles are
            well-maintained and equipped with the latest safety features.
          </p>
          <br />
          <h4>&ensp;&ensp;Quality Cars</h4>
          <p>
            Choose from top-tier models, each offering exceptional performance
            and style. Be assured that we take pride in supporting and keeping
            our cars in excellent condition, so you can enjoy a smooth and
            reliable driving journey.
          </p>
          <br />
          <h4>&ensp;&ensp;Great Experience</h4>
          <p>
            We’re committed to providing you with a memorable driving adventure.
            Whether it’s the thrill of open-air motoring or the comfort of
            advanced climate control, you will enjoy every moment on the road.
          </p>
        </div>
      </UiContentOverflow>
    </div>
